                ...
                {/* Main site routes - with elegant layout */}
                  ...
                  <Route path="/internal/v2" element={<ProtectedLayout />}>
                    <Route element={<InternalLayoutNew />}>
                      ...
                      {/* AI Digital Engine Routes - Wrapped in Error Boundaries */}
                      <Route path="ai/operations" element={
                        <ErrorBoundary fallbackTitle="Operations AI Error">
                          <OperationsAI />
                        </ErrorBoundary>
                      } />
                      <Route path="ai/content" element={
                        <ErrorBoundary fallbackTitle="Content Engine Error">
                          <ContentEngine />
                        </ErrorBoundary>
                      } />
                      <Route path="ai/ads" element={
                        <ErrorBoundary fallbackTitle="Ads Engine Error">
                          <AdsEngine />
                        </ErrorBoundary>
                      } />
                      
                      {/* Existing Routes - Wrapped in Error Boundaries */}
                      ...
                      <Route path="leads" element={
                        <ErrorBoundary fallbackTitle="Leads Pipeline Error">
                          <LeadsPipeline />
                        </ErrorBoundary>
                      } />
                      ...
                      <Route path="inspections/new" element={
                        <ErrorBoundary fallbackTitle="Inspection Builder Error">
                          <InspectionBuilderNew />
                        </ErrorBoundary>
                      } />
                      ...
                      <Route path="jobs" element={
                        <ErrorBoundary fallbackTitle="Jobs Calendar Error">
                          <JobsCalendar />
                        </ErrorBoundary>
                      } />
