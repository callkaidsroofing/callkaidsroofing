  ...
  const saveReport = async (data: any) => {
    ...
    try {
      const reportPayload = {
        ...
        email: data.clientSite.email || null,
        ...
        tileProfile: data.roofDetails.tileProfile || null,
        tileColour: data.roofDetails.tileColour || null,
        ageApprox: data.roofDetails.ageApprox || null,
        roofPitch: data.roofDetails.roofPitch || null,
        ridgeCaps: data.measurements.ridgeCaps || null,
        brokenTiles: data.measurements.brokenTiles || null,
        gableLengthLM: data.measurements.gableLengthLM || null,
        valleyLength: data.measurements.valleyLength || null,
        gutterPerimeter: data.measurements.gutterPerimeter || null,
        roofArea: data.measurements.roofArea || null,
        brokenTilesCaps: data.condition.brokenTilesCaps || null,
        brokenTilesNotes: data.condition.brokenTilesNotes || null,
        pointing: data.condition.pointing || null,
        pointingNotes: data.condition.pointingNotes || null,
        valleyIrons: data.condition.valleyIrons || null,
        valleyIronsNotes: data.condition.valleyIronsNotes || null,
        boxGutters: data.condition.boxGutters || null,
        boxGuttersNotes: data.condition.boxGuttersNotes || null,
        guttersDownpipes: data.condition.guttersDownpipes || null,
        guttersDownpipesNotes: data.condition.guttersDownpipesNotes || null,
        penetrations: data.condition.penetrations || null,
        penetrationsNotes: data.condition.penetrationsNotes || null,
        internalLeaks: data.condition.internalLeaks || null,
        brokentilesphoto: data.photos.brokentilesphoto || [],
        pointingphoto: data.photos.pointingphoto || [],
        valleyironsphoto: data.photos.valleyironsphoto || [],
        boxguttersphoto: data.photos.boxguttersphoto || [],
        guttersphoto: data.photos.guttersphoto || [],
        penetrationsphoto: data.photos.penetrationsphoto || [],
        leaksphoto: data.photos.leaksphoto || [],
        beforedefects: data.photos.beforedefects || [],
        duringafter: data.photos.duringafter || [],
        recommendedWorks: data.recommendedWorks.workItems || [],
        pointingColour: data.materialsSafety.pointingColour || null,
        beddingCementSand: data.materialsSafety.beddingCementSand || null,
        specTileProfile: data.materialsSafety.specTileProfile || null,
        specTileColour: data.materialsSafety.specTileColour || null,
        paintSystem: data.materialsSafety.paintSystem || null,
        paintColour: data.materialsSafety.paintColour || null,
        flashings: data.materialsSafety.flashings || null,
        otherMaterials: data.materialsSafety.otherMaterials || null,
        heightStoreys: data.materialsSafety.heightStoreys || null,
        safetyRailNeeded: data.materialsSafety.safetyRailNeeded || false,
        accessNotes: data.materialsSafety.accessNotes || null,
        overallCondition: data.summary.overallCondition || null,
        priority: data.summary.priority || null,
        overallConditionNotes: data.summary.overallConditionNotes || null,
    ...
    switch (currentStep) {
      case 1:
        return (
          ...
          reportData.clientSite.date &&
          reportData.clientSite.time &&
          reportData.clientSite.inspector
        );
      case 2:
