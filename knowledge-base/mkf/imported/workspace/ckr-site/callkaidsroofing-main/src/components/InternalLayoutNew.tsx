...
import { 
  ...
  ChevronDown, Shield, RefreshCw, Cpu, Zap, Target
} from 'lucide-react';
...
const navStructure: NavSection[] = [
  {
    title: 'AI Digital Engine',
    icon: Cpu,
    defaultOpen: true,
    items: [
      { title: 'Operations AI', path: '/internal/v2/ai/operations', icon: Zap },
      { title: 'Content Engine', path: '/internal/v2/ai/content', icon: Sparkles },
      { title: 'Meta Ads Engine', path: '/internal/v2/ai/ads', icon: Target },
    ],
  },
  {
    title: 'CRM',
