                ...
                <CardContent className="p-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      <textarea
                        name="message"
                        placeholder="Tell us about your roof's current condition (optional)"
                    ...
                    >
                      {isSubmitting ? 'Booking Health Check...' : '🏠 Get FREE Roof Health Check'}
                    </Button>

                    <div className="text-center">
                      <p className="text-sm text-muted-foreground mb-2">
                        Or call directly to discuss your restoration:
                      </p>
