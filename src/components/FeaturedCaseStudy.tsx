      ...
      <div className="space-y-4">
        ...
        <div className="relative bg-secondary rounded-xl overflow-hidden aspect-[4/3]">
          ...
          <div className="absolute top-4 left-4">
            <Badge variant="default" className="text-sm font-bold shadow-lg bg-primary">
        ...
        <div className="lg:sticky lg:top-24">
          <Card className="bg-white border-2 border-border">
            <CardContent className="p-6">
              ...
              {/* Review Screenshot */}
              {caseStudy.customerReview.imageUrl && (
                <div className="border border-border rounded-lg overflow-hidden">
                  <img
                    src={caseStudy.customerReview.imageUrl}
